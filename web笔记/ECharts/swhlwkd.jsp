	   ...
	   usernum="";
		...
		fileReader.onload = function(ev) {
          ...
          var jsondata=to_csv(workbook).split('\n');
		   ...
		   var table=null;
		     dimension = $("#sel_item dt").text();
			if(dimension=="互联网电视"){
			    _insert = _controller + '/swhlwSave.ilf';
				table="A_FT_PRV_Outbound_INTV";
			userDataTitle="START_time,city_name,sample,intv_nps,intv_csr,play_fluency,play_clarity,content_rich,tv_live,request_fee,phone_complain,search_convience,";
			 }else{
				 _insert = _controller + '/swkdSave.ilf'; 
				table="A_FT_PRV_Outbound_broadband";
			userDataTitle="start_time,city_name,telephone,carrier_operator,cs1_grade,Q1_GRADE,Q2_GRADE,Q3_GRADE,Q4_GRADE,Q5_GRADE,Q6_GRADE,Q7_GRADE,N2_GRADE,";
			}
		 var jsonList={};
...
if(city=='123'){
	...
	$('#searchBtn').bind("click", function() {
		...
		if(dimension=="互联网电视"){
			 reportId = "1860";
			LoadTableLayout("省内外呼互联网电视调查样本","data1",'#table1',reportId);
		}else{
			 reportId = "1859";
			LoadTableLayout("省内外呼宽带调查样本","data1",'#table1',reportId);
...
<div style="box-shadow: 0 2px 5px #ebeff1;margin-top: 10px;">
	<div class="panle panlenotitle" style="line-height: 24px;min-height:28px;">
		...
		<div class="search-group" id="div_sel_city">
		   ...
		   <div class="search-group" id="div_sel_item">
				<dl class="select" id="sel_item" style="z-index: 200">
				    <dt value="">
						工单状态
					</dt>
					<dd>
